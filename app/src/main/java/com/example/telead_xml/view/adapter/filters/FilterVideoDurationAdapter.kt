...
class FilterVideoDurationAdapter(val list: ArrayList<FilterCategoryData>, val listener: FilterListener) : RecyclerView.Adapter<FilterVideoDurationAdapter.ViewHolder>() {
