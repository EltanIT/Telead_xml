...
class FilterVideoDurationAdapter(val list: ArrayList<FilterCategoryData>, val filter: ArrayList<String>?, val listener: FilterListener) : RecyclerView.Adapter<FilterVideoDurationAdapter.ViewHolder>() {
